...
UI: Jetpack Compose (100% Kotlin 기반의 선언형 UI로 개발)

Architecture: MVVM (Model-View-ViewModel)

Asynchronous: Coroutines (비동기 데이터 처리 및 UI 응답성 유지)

Dependency Injection: Hilt (객체 간 의존성 관리 및 보일러플레이트 코드 감소)

Networking: Retrofit2 (서버 API 통신)

Database: Room DB (로그인 토큰 등 로컬 데이터 관리)

Paging: Paging3 (뉴스 피드 무한 스크롤 및 데이터 관리)
